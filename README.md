...
We have added a route, now its time to make changes in controller tweet.js. Controller accepts the request and stores data and generates a response for Frontend.
